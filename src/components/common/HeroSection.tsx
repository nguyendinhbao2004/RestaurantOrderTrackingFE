...
export function HeroSection() {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 bg-violet-50 dark:bg-violet-950/20" />

            {/* Floating orbs animation */}
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-violet-400/30 rounded-full blur-3xl animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-violet-400/30 rounded-full blur-3xl animate-pulse delay-1000" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 mb-8 animate-fadeIn">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-slideUp animation-delay-400">
                    <Button
                        size="lg"
                        className="bg-violet-600 hover:bg-violet-700 text-white border-0 text-lg px-8 h-12 rounded-full shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/30 transition-all duration-300 hover:scale-105"
                    >
                        Get Started Free
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto animate-slideUp animation-delay-600">
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-bold text-violet-600">50K+</div>
                    ...
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-bold text-violet-600">150ms</div>
                        <div className="text-sm text-muted-foreground mt-1">Avg. Response</div>
                    </div>
                    <div className="text-center">
                        <div className="text-3xl md:text-4xl font-bold text-violet-600">4.9/5</div>
