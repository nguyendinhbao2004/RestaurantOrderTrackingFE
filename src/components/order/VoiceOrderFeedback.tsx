    ...
    <Card className="border-orange-500/30 bg-orange-50/50 dark:bg-orange-950/20 backdrop-blur-sm shadow-lg shadow-orange-500/5 overflow-hidden">
      ...
      <CardContent className="space-y-3 p-3 sm:p-4">
          ...
          <div className="min-w-0 flex items-center gap-2">
            {isListening ? (
              <>
                ...
                <span className="truncate text-sm font-medium text-orange-700 dark:text-orange-300">
                  Đang lắng nghe...
                </span>
              </>
            ) : (
              <span className="truncate text-sm font-medium text-muted-foreground">
                Kết quả đặt món bằng giọng nói
              </span>
            )}
          </div>
          <div className="flex items-center gap-1">
        ...
        {(transcript || interimTranscript) && (
          <div className="rounded-lg border border-orange-200/50 bg-white/60 p-3 dark:border-orange-800/30 dark:bg-white/5">
            ...
            <div className="space-y-2">
              ...
              {matchedItems.map((item, index) => (
                <div
                  ...
                  className="animate-in slide-in-from-left-2 duration-300 flex items-center justify-between gap-2 rounded-lg border border-emerald-200/50 bg-emerald-50/60 p-2 dark:border-emerald-800/30 dark:bg-emerald-950/20"
        ...
        {!isListening &&
          ...
          !error && (
            <div className="p-2 bg-amber-50 dark:bg-amber-950/20 rounded-lg text-amber-700 dark:text-amber-300 text-sm text-center">
              No menu items matched. Try saying specific dish names like
              &quot;Ribeye Steak&quot; or &quot;Lemonade&quot;.
            </div>
          )}
      </CardContent>
    </Card>
