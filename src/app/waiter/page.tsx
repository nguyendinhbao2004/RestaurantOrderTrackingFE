                        ...
                        {readyOrders.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {readyOrders.map((order) => (
                                    <Card key={order.id} className="border-emerald-500/50 bg-emerald-500/5">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {tables.slice(0, 12).map((table) => (
                                <Card
                                    key={table.id}
                                    className={`text-center ${table.status === "available"
                                ...
                                >
                                    <CardContent className="p-3">
                                        ...
                                        <div className={`text-xs ${getTableStatusColor(table.status)} text-white px-1.5 py-0.5 rounded mt-1 inline-block`}>
