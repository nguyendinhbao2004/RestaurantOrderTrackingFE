...
export default function CashierPage() {
    ...
    const waitingPaymentTables = tables.filter((t) => t.status === "waiting-payment");
                    ...
                    <Card className="bg-violet-500/10 border-violet-500/20">
                        <CardContent className="p-4 text-center">
                            <div className="text-3xl font-bold text-violet-600 dark:text-violet-400">
                                {todayOrders > 0 ? formatCurrency(todayRevenue / todayOrders) : "$0"}
                            </div>
                        ...
                        {waitingPaymentTables.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {waitingPaymentTables.map((table) => {
                                    ...
                                    return (
                                        <Card key={table.id} className="border-rose-500/50 bg-rose-500/5">
                                            <CardHeader className="pb-3">
                                                <div className="flex items-center justify-between">
                                                    <CardTitle className="text-lg">Table {table.number}</CardTitle>
                                                    <Badge className="bg-rose-500 text-white">PAYMENT DUE</Badge>
                                                </div>
                                            </CardHeader>
                                            <CardContent>
                                                {tableOrder && (
                        ...
                        <Card>
                            <CardContent className="p-0">
                                <div className="divide-y">
                                    {servedOrders.slice(-5).reverse().map((order) => (
